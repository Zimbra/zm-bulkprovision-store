            ...
            if (entries != null) {
                ...
                if (FILE_FORMAT_PREVIEW.equalsIgnoreCase(fileFormat)) {
                    ...
                    try {
                        ...
                        for (GalContact entry : entries) {
                            ...
                            if (password != null) {
                                ...
                                ePassword.setText(String.valueOf(BulkImportAccounts
                                        .generateStrongPassword(genPwdLength)));
                            }
                            eUser.add(ePassword);

                            org.dom4j.Element elMustChangePassword = DocumentHelper
                                    .createElement(Provisioning.A_zimbraPasswordMustChange);
                    ...
                    try {
                        ...
                        if ("TRUE".equalsIgnoreCase(request.getElement(AdminExtConstants.E_importContacts)
                                .getTextTrim())) {
                        ...
                        if ("TRUE".equalsIgnoreCase(request.getElement(AdminExtConstants.E_importCalendar)
                                .getTextTrim())) {
                        ...
                        if ("TRUE".equalsIgnoreCase(request.getElement(AdminExtConstants.E_importDeletedItems)
                                .getTextTrim())) {
                        ...
                        if ("TRUE".equalsIgnoreCase(request.getElement(AdminExtConstants.E_ignorePreviouslyImported)
                                .getTextTrim())) {
                        ...
                        adminUserPasswordEl.setText(request.getElement(AdminExtConstants.E_ZimbraAdminPassword)
                                .getTextTrim());
                        ...
                        if ("TRUE".equalsIgnoreCase(request.getElement(AdminExtConstants.E_provisionUsers)
                                .getTextTrim())) {
